...
IMPLEMENT_DYNAMIC(XResolution, CDialogEx)

XResolution::XResolution(CWnd* pParent /*=NULL*/)
	: CDialogEx(XResolution::IDD, pParent)
{
...
void XResolution::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(XResolution, CDialogEx)
	ON_BN_CLICKED( IDC_BUTTON_OK, &XResolution::OnBtnOK)
	ON_BN_CLICKED(IDC_BUTTON_CENCLE, &XResolution::OnBtnCancle)
	ON_STN_CLICKED(IDC_STATIC_EXPAND, &XResolution::OnClickedExpand)
	ON_CBN_SELCHANGE(IDC_COMBO_INDEX, &XResolution::OnSelchangeIndex)
	ON_CBN_SELCHANGE(IDC_COMBO_REFRESH, &XResolution::OnSelchangeRefresh)
END_MESSAGE_MAP()

void XResolution::SetDelegate(XDelegateResolution* p)
{
	m_Delegate=p;
}

void XResolution::SetScreenManage(XScreenManage* p)
{
	m_pScreenManage=p;
}

void XResolution::SetScreen(XScreen*& p)
{
	m_pScreen=p;
}

BOOL XResolution::OnInitDialog()
{
...
void XResolution::ReloadInterface()
{
...
void XResolution::OnBtnOK()
{
	...
	//////////////////////////////////////////////////////////////////////////
	XResulationInfo* pResulation=m_pScreen->GetResulationInfo();
...
void XResolution::OnBtnCancle()
{
	CDialogEx::OnCancel();
}

void XResolution::OnClickedExpand()
{
	CString str;
...
void XResolution::OnSelchangeIndex()
{
	CString nSelectStr=_T("");
	m_Combo_Index.GetLBText(m_Combo_Index.GetCurSel(),nSelectStr);

	if(nSelectStr==_T("分辨率1")
		||nSelectStr==_T("Resulation1"))//800 600
	{
	...
	else if(nSelectStr==_T("分辨率2")
		||nSelectStr==_T("Resulation2"))//1024 768
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率3")
		||nSelectStr==_T("Resulation3"))//1280 720
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
	...
	else if(nSelectStr==_T("分辨率4")
		||nSelectStr==_T("Resulation4"))//1280 768
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率5")
		||nSelectStr==_T("Resulation5"))//1280 800
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率6")
		||nSelectStr==_T("Resulation6"))//1280 1024
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率7")
		||nSelectStr==_T("Resulation7"))//1360 768
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率8")
		||nSelectStr==_T("Resulation8"))//1366 768
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率9")
		||nSelectStr==_T("Resulation9"))//1440 900
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率10")
		||nSelectStr==_T("Resulation10"))//1440 1050
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率11")
		||nSelectStr==_T("Resulation11"))//1600 900
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率12")
		||nSelectStr==_T("Resulation12"))//1680 1050
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
	...
	else if(nSelectStr==_T("分辨率13")
		||nSelectStr==_T("Resulation13"))//1920 1080
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.AddString(_T("50"));
	...
	else if(nSelectStr==_T("分辨率14")
		||nSelectStr==_T("Resulation14"))//1920 1200
	{
		m_Combo_Refresh.ResetContent();
		m_Combo_Refresh.AddString(_T("60"));
		m_Combo_Refresh.SetCurSel(0);
...
void XResolution::OnSelchangeRefresh()
{
	CString nSelectStr=_T("");
