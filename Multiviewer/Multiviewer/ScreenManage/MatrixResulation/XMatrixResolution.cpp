...
IMPLEMENT_DYNAMIC(XMatrixResolution, CDialogEx)

XMatrixResolution::XMatrixResolution(CWnd* pParent /*=NULL*/)
	: CDialogEx(XMatrixResolution::IDD, pParent)
{
	
}

XMatrixResolution::~XMatrixResolution()
{
}

void XMatrixResolution::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(XMatrixResolution, CDialogEx)
	ON_BN_CLICKED( IDC_BUTTON_OK, &XMatrixResolution::OnBtnOK)
	ON_BN_CLICKED(IDC_BUTTON_CENCLE, &XMatrixResolution::OnBtnCancle)
	ON_STN_CLICKED(IDC_STATIC_EXPAND, &XMatrixResolution::OnClickedExpand)
	ON_CBN_SELCHANGE(IDC_COMBO_INDEX, &XMatrixResolution::OnSelchangeIndex)
	ON_CBN_SELCHANGE(IDC_COMBO_REFRESH, &XMatrixResolution::OnSelchangeRefresh)
END_MESSAGE_MAP()

void XMatrixResolution::SetDelegate(XDelegateMatrixResolution* p)
{
	m_Delegate=p;
}

void XMatrixResolution::SetScreenManage(XScreenManage* p)
{
	m_pScreenManage=p;
}

void XMatrixResolution::SetScreen(XScreen*& p)
{
	m_pScreen=p;
}

BOOL XMatrixResolution::OnInitDialog()
{
...
void XMatrixResolution::SetDialog()
{
	CRect rtSmall;
...
void XMatrixResolution::InitCombo()
{
...
void XMatrixResolution::InitShowData()
{
...
void XMatrixResolution::ReloadInterface()
{
...
void XMatrixResolution::OnBtnOK()
{
...
void XMatrixResolution::OnBtnCancle()
{
	CDialogEx::OnCancel();
}

void XMatrixResolution::OnClickedExpand()
{
	CString str;
...
void XMatrixResolution::OnSelchangeIndex()
{
...
void XMatrixResolution::OnSelchangeRefresh()
{
	CString nSelectStr=_T("");
