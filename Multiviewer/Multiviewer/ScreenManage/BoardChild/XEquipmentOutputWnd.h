...
class XEquipmentOutputWnd : public CWnd
{
	DECLARE_DYNAMIC(XEquipmentOutputWnd)

public:
	XEquipmentOutputWnd();
	virtual ~XEquipmentOutputWnd();
...
public:
	...
	void SetEquipmentOutput(XEquipmentOutput* p);
...
private:
	...
	XEquipmentOutput* m_EquipmentOutput;
